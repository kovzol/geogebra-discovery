...
if __name__ == "__main__":
    ...
    add_translation(INCIRCLECENTER, EN, 'Incircle Center', ZK)
    add_translation(INCIRCLECENTER, HU, 'Beírható kör középpontja', ZK)
    add_translation(INCIRCLECENTER, DE, 'Inkreismittelpunkt', ZK)
    add_translation(INCIRCLECENTER, ES, 'Centro de la circunferencia inscrita', ZK)
